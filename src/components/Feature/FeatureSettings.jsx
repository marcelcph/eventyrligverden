const services = [
  {
    label: "Hvad kan vi",
    Overskrift: "Lorum ipsum dolor sit amet",
    beskrivelse:
      "Lorum ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus feugiat, molestie ipsum et, consequat nibh. Etiam non elit dui. Nullam vel eros sit amet arcu vestibulum accumsan in in leo.",
    // Første card
    Card1title: "Hvad vi kan tilbyde",
    svgPath: (
      <path
